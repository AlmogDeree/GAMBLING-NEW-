...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`http://192.248.151.61:5000${endpoint}`, payload);
  ...
  const quickTest = async () => {
    ...
    try {
      ...
      try {
        await axios.post('http://192.248.151.61:5000/api/register', {
          username: 'testuser',
          email: 'test@test.com',
          password: '123456'
        });
      ...
      // התחברות
      const response = await axios.post('http://192.248.151.61:5000/api/login', {
        email: 'test@test.com',
        password: '123456'
      });
