...
import { 
  History, Trophy, Volume2, VolumeX, Crown, TrendingUp, 
  Users, Zap, Copy, Play, Minus, Plus, X
} from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-gray-800/60 hover:bg-gray-700/70 transition-colors border border-gray-600"
                  ...
                  {[...Array(range)].map((_, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isCold && <div className="absolute -top-1 -right-1 w-2 h-2 bg-blue-500 rounded-full"></div>}
                      </motion.button>
                    );
                  })}
                </div>
