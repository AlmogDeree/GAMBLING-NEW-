          ...
          <>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-8">
              ...
              >
                ...
                <div className="text-sm text-white mt-1">{t.referralEarnings}</div>
              </motion.div>
              ...
              >
                ...
                <div className="text-sm text-white mt-1">{t.totalReferrals}</div>
              </motion.div>
              ...
              >
                ...
                <div className="text-sm text-white mt-1">Active Players</div>
              </motion.div>
              ...
              >
                ...
                <div className="text-sm text-white mt-1">Commission Rate</div>
              </motion.div>
            </div>
